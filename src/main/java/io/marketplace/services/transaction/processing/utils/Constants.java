...
public class Constants {
    ...
    public static final String INSUFFICIENT_BALANCE_ERROR_CODE = "008.S01.400.02";
    ...
    public static class EventTitle {
        ...
        public static final String WALLET_DATA_RECV_REQUEST =
                "Received the kafka message for the wallet-data-changed.";
        public static final String WALLET_DATA_RECV_RESPONSE =
                "Successfully processed the kafka message for the wallet-data-changed.";
        public static final String TRANSACTION_DATA_RECV_REQUEST =
                "Received the kafka message for the transaction-data-changed.";
        public static final String TRANSACTION_DATA_RECV_RESPONSE =
                "Successfully processed the kafka message for the transaction-data-changed";
        public static final String INVOKE_WALLET_BY_ACCOUNT_NUMBER =
                "Invoke wallet service for retrive wallet id by account number";
        public static final String RESPONSE_WALLET_BY_ACCOUNT_NUMBER =
                "Getting wallet info response by account number";
    }
    ...
    public static class UseCase {
        ...
        public static final String ACTIVITY_RECEIVE_TRANSACTION_DATA =
                "Transaction data received for round up contribution";
        public static final String RECEIVE_WALLET_DATA_CHANGED_FROM_KAFKA =
                "Receive Wallet data changed from Kafka";
